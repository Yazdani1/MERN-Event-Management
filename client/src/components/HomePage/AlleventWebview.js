...
const AlleventWebview = ({
  ...
  return (
    <React.Fragment>
      <div className="large-to-medium-screen-allevents">
        <div className="card all-events">
          ...
          <Link to={"/event-details-page/"+postid} style={{ textDecoration: "none", color: "black" }}>
            <h5>{name}</h5>
...
export default AlleventWebview;
